...
function GetIslandsList()
{
	...
	islands[0]  = new IslandInfo("济州岛", "jeju/jejudo.html", "2万/4天", "7小时", "5月-9月", "海滩，观光","牛岛", "", "", "落地签", "邮轮", ">4岁");
	islands[1]  = new IslandInfo("冲绳","okinawa.html","","","","","","", "", "是","","");
	islands[2]  = new IslandInfo("普吉岛","phuket/phuket.html","2.5万/5天","10小时","11月-4月","寺庙，表演，潜水，攀牙湾","皮皮岛,皇帝岛","巴厘岛,塞班岛","邓海军","是","",">4岁");
	islands[3]  = new IslandInfo("塞班岛","saipan/saipan.html","3万/4天","12小时","12月-6月","潜水，水上运动","军舰岛","普吉岛,巴厘岛","邓海军","落地签","",">4岁");
	islands[4]  = new IslandInfo("巴厘岛","bali/bali.html","2万/5天","14小时","6月-9月","","","普吉岛,塞班岛","","落地签","",">4岁");
	islands[5] 	= new IslandInfo("新加坡","singapore/singapore.html","2.5万/4天","11小时","6月-9月","动物园，圣淘沙","巴丹岛","香港","邓海军","是","",">6岁");
	islands[6] 	= new IslandInfo("民丹岛","pulaubintan.html","","","","","","","","落地签","",">6岁");
	islands[7] 	= new IslandInfo("马尔代夫","maledive/maledive.html","4.5万/4天","11小时 (Male)","5月-10月","潜水、钓鱼、海洋动物","","帕劳","邓海军","免签","",">8岁");
	islands[8] 	= new IslandInfo("帕劳","palau.html","","","","潜水","","马尔代夫","","免签","",">8岁");
	islands[9] 	= new IslandInfo("沙巴","sabah.html","","","","","","","","是","安全顾虑","");
	islands[10] = new IslandInfo("长滩","boracay.html","2万/5天","12小时","","海滩，性价比高","","","","是","","");
	islands[11] = new IslandInfo("圣托里尼","santorini/santorini.html","5万/8天","15-20小时 (雅典)","5月-10月","历史，摄影","雅典","扎金索斯, 米诺克斯","邓海军","是","",">10岁");
	islands[12] = new IslandInfo("大堡礁","GreatBarrierReef.html","","","","","","","","是","",">8岁");
	islands[13] = new IslandInfo("塞舌尔","seychelles.html","6万/8天","","","","","","","免签","","");
